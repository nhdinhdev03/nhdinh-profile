 ...
 */
@Repository
public interface BlogPostTranslationDAO extends JpaRepository<BlogPostTranslation, UUID> {
    ...
    Optional<BlogPostTranslation> findByBlogIdAndLanguageCode(@Param("blogId") UUID blogId,
