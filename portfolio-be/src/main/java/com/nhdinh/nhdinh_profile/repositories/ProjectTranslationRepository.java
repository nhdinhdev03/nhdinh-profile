...
import com.nhdinh.nhdinh_profile.modules.Project.ProjectTranslation;
...
public interface ProjectTranslationRepository extends JpaRepository<ProjectTranslation, UUID> {
    ...
    Optional<ProjectTranslation> findByProjectIdAndLanguageCode(@Param("projectId") UUID projectId, @Param("languageCode") String languageCode);
    ...
    boolean existsByProjectIdAndLanguageCode(@Param("projectId") UUID projectId, @Param("languageCode") String languageCode);
