  ...
  return (
    <div className="quantum-home">
      ...
      <main className={`quantum-content ${isLoaded ? 'loaded' : ''}`}>
        ...
        {/* Skills Marquee */}
        <section className="quantum-skills">
          <h2 className="section-title">QUANTUM ARSENAL</h2>
        ...
        {/* About Preview */}
        <section className="quantum-about">
          <div className="about-content">
            <div className="about-text">
              <h2 className="section-title">ABOUT THE ARCHITECT</h2>
              <p>
                I'm a passionate full-stack developer with expertise in modern web technologies.
                Specialized in React, Node.js, and cloud architecture. Always pushing the boundaries
                of what's possible in the digital realm.
              </p>
              <button 
                className="quantum-cta tertiary"
...
{`const developer = {
  ...
  status: "Available for hire"
        ...
        <section className="quantum-projects">
          ...
          <div className="projects-grid">
            <div className="project-card" data-aos="fade-up">
              ...
              <div className="project-info">
                ...
                <p>Full-stack e-commerce solution with React & Node.js</p>
            ...
            <div className="project-card" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="project-info">
                ...
                <p>Modern dashboard with real-time analytics</p>
                <div className="project-tech">
                  <span>Vue.js</span>
                  <span>Express</span>
        ...
        <section className="quantum-cta-section">
          <div className="cta-content">
            ...
            <p>Let's collaborate and create the next quantum leap in digital innovation.</p>
            <button 
              className="quantum-cta primary large"
              onClick={() => navigate(ROUTES.CONTACT)}
            >
