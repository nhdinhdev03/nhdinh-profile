...
function HomeIndex() {
  ...
  const [statsRef, showStats] = useVisibility({
    ...
    rootMargin: isMobile ? "0px 0px 120px 0px" : "0px 0px 240px 0px",
  });
  const [projectsRef, showProjects] = useVisibility({
    threshold: isMobile ? 0.15 : 0.08,
    rootMargin: isMobile ? "0px 0px 160px 0px" : "0px 0px 320px 0px",
  });
  const [marqueeRef, showMarquee] = useVisibility({
    threshold: 0.05,
    rootMargin: isMobile ? "0px 0px 200px 0px" : "0px 0px 400px 0px",
  });
